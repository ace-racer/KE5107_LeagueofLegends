...
Exploring best champions to use using only top position data
...
There are 75 different champions used in the top position. (According to summary this is the full list of heroes)
