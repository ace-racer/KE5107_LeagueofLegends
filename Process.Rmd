...
if(shouldDiscardTimeSeriesColumnsFromProcessedFile){
  ...
  {
    column_name <- unlist(timeSeriesColumnNames[i])
    matches_data[,column_name] <- NULL
  }
...
```{r}
write.csv(matches_data, processedFileNameWithExtension, row.names = FALSE)
```
