...
firstKillElements <- c("Towers", "Inhibs", "Dragons", "Barons", "Kills") 
...
#golddiff_times
matches_total$golddiff_5mins <- golddiff_times$X5
#matches_total$golddiff_5mins
matches_total$golddiff_10mins <- golddiff_times$X10
#matches_total$golddiff_10mins
matches_total$golddiff_20mins <- golddiff_times$X20
#matches_total$golddiff_20mins
...
result_20mins <-matches_total[which((strtoi(matches_total$golddiff_20mins, base = 0L))<0 & matches_total$bResult == '0'),]
...
result_20mins <-matches_total[which((strtoi(matches_total$golddiff_20mins, base = 0L))<0 & matches_total$bResult == '1'),]
...
result_10mins <-matches_total[which((strtoi(matches_total$golddiff_10mins, base = 0L))<0 & matches_total$bResult == '0'),]
...
result_10mins <-matches_total[which((strtoi(matches_total$golddiff_10mins, base = 0L))<0 & matches_total$bResult == '1'),]
...
matchesData_seperated <- matchesData %>%
  separate(as.numeric(golddiff), into = c(create_column_names(max(matchesData$gamelength), "gold_diff_in_minute")), sep = "\\,")

bans_seperated <- matchesData %>%    
  separate(blueBans, into = c(create_column_names(5, "bansblue")), sep = "\\,")%>% 
  separate(redBans, into = c(create_column_names(5, "bansred")), sep = "\\,")

# Make them numeric
matchesData_seperated <- japply(matchesData_seperated, c(create_column_names(max(matchesData$gamelength), "gold_diff_in_minute")), as.numeric )
# Hooray it works:
str(matchesData_seperated$gold_diff_in_minute_80)
